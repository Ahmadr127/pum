...
<div class="w-full">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <div class="bg-gray-50 px-4 py-3 border-b border-gray-200">
            <form action="{{ route('pum-releases.index') }}" method="GET">
                <div class="flex flex-wrap items-end gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <a href="{{ route('pum-releases.index') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-1.5 px-3 rounded text-sm">
                            Reset
                        </a>
                    </div>
                </div>
        ...
        <div class="bg-white px-4 py-2 border-b border-gray-200">
            <div class="flex flex-wrap items-center gap-4 text-xs">
                ...
                <span class="inline-flex items-center">
                    <i class="fas fa-check-circle text-green-500 mr-1"></i> Selesai/Terpenuhi [{{ $summary['fulfilled'] + $summary['approved'] }}]
                </span>
