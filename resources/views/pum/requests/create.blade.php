        ...
        <div class="p-6 bg-white border-b border-gray-200">
            ...
            <form action="{{ route('pum-requests.store') }}" method="POST" id="pumRequestForm" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <select name="workflow_id" id="workflow_id" 
                                ...
                                @foreach($workflows as $workflow)
                                    <option value="{{ $workflow->id }}" {{ $workflow->is_default ? 'selected' : '' }}>
                ...
                <div class="mt-6 flex justify-end gap-3 border-t border-gray-200 pt-6">
                    <a href="{{ route('pum-requests.index') }}" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200 font-medium">
                        Batal
                    </a>
