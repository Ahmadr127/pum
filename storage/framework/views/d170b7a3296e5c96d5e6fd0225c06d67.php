<?php $__env->startSection('title', 'Kelola Permissions'); ?>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?php echo e(route('permissions.create')); ?>" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                    Tambah Permission
                </a>
            </div>
        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table-filter','data' => ['searchPlaceholder' => 'Cari nama permission atau display name...']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['search-placeholder' => 'Cari nama permission atau display name...']); ?>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($permission->display_name); ?></div>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="<?php echo e(route('permissions.edit', $permission)); ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /mnt/data/Education/Pemrograman/magang/pum/pum/resources/views/permissions/index.blade.php ENDPATH**/ ?>