...
<div class="w-full px-4" x-data="workflowEditForm()">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            ...
            <form action="<?php echo e(route('pum-workflows.update', $pumWorkflow)); ?>" method="POST" @submit.prevent="submitForm">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <select name="procurement_category" id="procurement_category"
                                ...
                                <option value="barang_baru" <?php echo e(($condition && $condition->procurement_category == 'barang_baru') ? 'selected' : ''); ?>>Barang Baru</option>
                                <option value="peremajaan" <?php echo e(($condition && $condition->procurement_category == 'peremajaan') ? 'selected' : ''); ?>>Peremajaan</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <input type="number" name="amount_min" id="amount_min" value="<?php echo e($condition ? (float)$condition->amount_min : ''); ?>"
                        ...
                        <div>
                            ...
                            <input type="number" name="amount_max" id="amount_max" value="<?php echo e($condition ? (float)$condition->amount_max : ''); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Pemrograman\magang\pum\resources\views/pum/workflows/edit.blade.php ENDPATH**/ ?>