                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                                ...
                                <?php endif; ?>
                                <div class="mt-4">
                                    <label for="approve_notes_<?php echo e($modalName); ?>" class="block text-sm font-medium text-gray-700 mb-1">
                                        Catatan (Opsional)
                                    </label>
                                    <textarea 
                                        name="notes" 
                                        id="approve_notes_<?php echo e($modalName); ?>" 
                                        rows="3"
                                ...
                                <div class="mt-4">
                                    <label for="fs_form_<?php echo e($modalName); ?>" class="block text-sm font-medium text-gray-700 mb-1">
                                        Form FS (Opsional)
                                    ...
                                    <input 
                                        type="file" 
                                        name="fs_form" 
                                        id="fs_form_<?php echo e($modalName); ?>"
                                        accept=".pdf,.doc,.docx"
...
<?php /**PATH D:\Pemrograman\magang\pum\resources\views/components/pum/approve-modal.blade.php ENDPATH**/ ?>