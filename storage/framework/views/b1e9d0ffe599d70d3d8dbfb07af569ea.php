<?php $__env->startSection('title', 'Kelola Unit Organisasi'); ?>

<?php $__env->startSection('content'); ?>
<div class="w-full mx-auto" x-data="{
    ...tableFilter({
        search: '<?php echo e(request('search')); ?>',
        type_id: '<?php echo e(request('type_id')); ?>',
        is_active: '<?php echo e(request('is_active')); ?>'
    })
}">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?php echo e(route('organization-units.create')); ?>" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                    Tambah Unit
                </a>
            </div>
        </div>
        ...
        <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
            <form method="GET" class="flex flex-wrap gap-4 items-end">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="<?php echo e(route('organization-units.index')); ?>" class="bg-gray-300 hover:bg-gray-400 text-gray-700 px-4 py-2 rounded-md text-sm">
                        Reset
                    </a>
                </div>
            </form>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900"><?php echo e($unit->name); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex px-2 py-1 text-xs font-semibold rounded 
                                <?php if($unit->type->level == 1): ?> bg-purple-100 text-purple-800
                                <?php elseif($unit->type->level == 2): ?> bg-blue-100 text-blue-800
                                <?php elseif($unit->type->level == 3): ?> bg-green-100 text-green-800
                                <?php elseif($unit->type->level == 4): ?> bg-yellow-100 text-yellow-800
                                <?php else: ?> bg-gray-100 text-gray-800
                                <?php endif; ?>">
                                <?php echo e($unit->type->display_name); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-500"><?php echo e($unit->parent->name ?? '-'); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($unit->head->name ?? '-'); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="<?php echo e(route('organization-units.show', $unit)); ?>" class="text-green-600 hover:text-green-900 mr-3">Detail</a>
                            <a href="<?php echo e(route('organization-units.edit', $unit)); ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
                            <form action="<?php echo e(route('organization-units.destroy', $unit)); ?>" method="POST" class="inline">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /mnt/data/Education/Pemrograman/magang/pum/pum/resources/views/organization-units/index.blade.php ENDPATH**/ ?>