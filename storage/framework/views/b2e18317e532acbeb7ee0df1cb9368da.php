    ...
    <div class="max-w-full px-6">
        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="flex-1 min-w-0 space-y-6">
                ...
                <!-- Approval History -->
                 <?php if(auth()->id() == $pumRequest->requester_id || auth()->id() == $pumRequest->created_by || $canApprove): ?>
                <div class="bg-white overflow-hidden shadow-sm rounded-xl border border-gray-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <?php if($approval->fs_form_path): ?>
                                                <a href="<?php echo e(Storage::url($approval->fs_form_path)); ?>" target="_blank" class="text-blue-600 hover:text-blue-800" title="Lihat FS Form">
