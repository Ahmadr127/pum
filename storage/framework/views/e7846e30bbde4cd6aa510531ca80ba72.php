...
<?php $__env->startSection('title', 'Edit Permintaan - ' . $pumRequest->code); ?>
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6">
            <div>
                ...
                <div class="flex items-center gap-2 mt-1">
                    ...
                    <span class="font-mono font-medium text-gray-700 bg-gray-100 px-2 py-0.5 rounded text-xs"><?php echo e($pumRequest->code); ?></span>
                    <?php if (isset($component)) { $__componentOriginal8c81617a70e11bcf247c4db924ab1b62 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8c81617a70e11bcf247c4db924ab1b62 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.status-badge','data' => ['status' => $pumRequest->status]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($pumRequest->status)]); ?>
...
<?php endif; ?>
        ...
        <form action="<?php echo e(route('pum-requests.update', $pumRequest)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                ...
                <div class="p-8 space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <input type="hidden" name="requester_id" value="<?php echo e($pumRequest->requester_id); ?>">
                            <div class="flex items-center p-3 bg-gray-50 border border-gray-200 rounded-lg">
                                ...
                                <span class="font-medium text-gray-900"><?php echo e($pumRequest->requester->name ?? '-'); ?></span>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="request_date" id="request_date" 
                                   value="<?php echo e(old('request_date', $pumRequest->request_date->format('Y-m-d'))); ?>"
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'amount','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('amount', $pumRequest->amount)),'label' => '','placeholder' => '0','required' => true,'class' => 'text-xl font-semibold text-gray-900 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg py-3 px-4 w-full']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4"
                                  ...
                                  placeholder="Jelaskan secara rinci tujuan permintaan uang muka ini..."><?php echo e(old('description', $pumRequest->description)); ?></textarea>
                            ...
                            <div>
                                ...
                                <?php if($pumRequest->attachments && count($pumRequest->attachments) > 0): ?>
                                    <div class="mb-4 space-y-2">
                                        <?php $__currentLoopData = $pumRequest->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center justify-between p-3 bg-indigo-50 border border-indigo-100 rounded-lg text-sm">
                                            <div class="flex items-center gap-3 overflow-hidden">
                                                ...
                                                <a href="<?php echo e(Storage::url($attachment)); ?>" target="_blank" class="truncate text-indigo-700 hover:text-indigo-900 font-medium">
                                                    <?php echo e(basename($attachment)); ?>

                                                </a>
                                            </div>
                                            <label class="flex items-center gap-2 cursor-pointer">
                                                <input type="checkbox" name="remove_attachments[]" value="<?php echo e($index); ?>" class="rounded text-red-600 border-gray-300 focus:ring-red-500 w-4 h-4">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <?php if($pumRequest->attachments2 && count($pumRequest->attachments2) > 0): ?>
                                    <div class="mb-4 space-y-2">
                                        <?php $__currentLoopData = $pumRequest->attachments2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center justify-between p-3 bg-gray-50 border border-gray-200 rounded-lg text-sm">
                                            <div class="flex items-center gap-3 overflow-hidden">
                                                <i class="fas fa-paperclip text-gray-500"></i>
                                                <a href="<?php echo e(Storage::url($attachment)); ?>" target="_blank" class="truncate text-gray-700 hover:text-gray-900 font-medium">
                                                    <?php echo e(basename($attachment)); ?>

                                                </a>
                                            </div>
                                            <label class="flex items-center gap-2 cursor-pointer">
                                                <input type="checkbox" name="remove_attachments2[]" value="<?php echo e($index); ?>" class="rounded text-red-600 border-gray-300 focus:ring-red-500 w-4 h-4">
                                                <span class="text-xs text-red-600 font-medium">Hapus</span>
                                            </label>
                                        </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Pemrograman\magang\pum\resources\views/pum/requests/edit.blade.php ENDPATH**/ ?>