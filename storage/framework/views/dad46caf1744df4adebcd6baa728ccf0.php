<td class="px-3 py-2 whitespace-nowrap text-center">
    <div class="flex items-center justify-center gap-1">
        ...
        <?php if(auth()->user()->hasPermission('manage_pum') || $request->requester_id === auth()->id()): ?>
...
<?php /**PATH D:\Pemrograman\magang\pum\resources\views/pum/requests/columns/aksi-admin.blade.php ENDPATH**/ ?>